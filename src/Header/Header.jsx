...
function Header(props) {
  ...
  let headerClassName = headerState ? " header-open": ""
  ...
  return (
    <div className={`header${headerClassLoad}${headerClassNameScroll}${headerClassName}`} >
        ...
        <div className="header__account">
            ...
            <Link to="/Page/PesonalAccount/PersonalAccount" className="header__account__item account__personal">
              <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
